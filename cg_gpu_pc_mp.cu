//DEFINITION OF CG WITH PRECONDITIONING (SINGLE PRECISSION) AND NO PRINTS
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <math.h>
...
double cg_gpu_pc_mp(float *x,float *r,int maxiter,double rel,int *status,int Nx,int Ny,int nBytes)
{
   int k;
